...
second_elf = elves_calories.index(best_three[1]) + 1
third_elf = elves_calories.index(best_three[0]) + 1

# Answers
print(f"Elf number {best_elf} is carrying the most calories with a total of {most_calories} calories")
print(f"Elves {best_elf}, {second_elf} and {third_elf} are carrying a total of {sum(best_three)} calories")
